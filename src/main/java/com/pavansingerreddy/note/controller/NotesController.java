...
public class NotesController {
    ...
    public ResponseEntity<List<PagableNoteDto>> getPagedNotes(Principal principal,@RequestParam(name = "page",defaultValue = "0") int page,@RequestParam(name = "size",defaultValue = "10") int size) throws NoteDoesNotExistsException{
